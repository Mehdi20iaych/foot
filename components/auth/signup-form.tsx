  ...
  return (
    <Card className="w-full max-w-md mx-auto">
      <CardHeader className="text-center space-y-4">
        ...
        <div>
          <CardTitle className="text-2xl font-bold text-gray-900">Join the Contest</CardTitle>
          <CardDescription className="text-gray-600">Create your account and start predicting</CardDescription>
        </div>
      </CardHeader>
